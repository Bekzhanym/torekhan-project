...
SECRET_KEY = 'django-insecure-+!*flmb9wsq%%_1#_4t1)qzs4k8vi0drh^^a-%mj5wb_*3t5+z'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=1), # Теперь живет сутки
...
SWAGGER_SETTINGS = {
    ...
    'USE_SESSION_AUTH': False, # Отключаем сессии, чтобы не путались с токенами
}